...
static const struct net_proto_family fins_inet_family_ops = {
//.family = PF_INET,
		.family = 39, .create = fins_inet_create, .owner = THIS_MODULE, };
...
static int fins_inet_init(void) {
	...
	//(void) sock_register(&fins_inet_family_ops);
#ifdef CONFIG_SYSCTL
