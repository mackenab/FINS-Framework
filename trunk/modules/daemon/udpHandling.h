...
void sendmsg_out_udp(struct fins_module *module, struct nl_wedge_to_daemon *hdr, uint8_t *data, uint32_t data_len, uint32_t flags, struct sockaddr_in *dest_addr, int addr_len);
...
void recvmsg_in_udp(struct fins_module *module, struct linked_list *call_list, struct daemon_call *call, metadata *meta, uint8_t *msg, uint32_t msg_len, uint32_t addr_ip,
