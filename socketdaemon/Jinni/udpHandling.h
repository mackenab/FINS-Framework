...
void recvfrom_udp_orig(unsigned long long uniqueSockID, int socketCallType, int datalen, int flags, int symbol);
...
void setsockopt_udp(unsigned long long uniqueSockID, int level, int optname, int optlen, void *optval);
void listen_udp();
void accept_udp();
void accept4_udp();
