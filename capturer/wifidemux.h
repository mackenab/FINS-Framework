...
/** FINS related data structures */
extern struct queue *wifi_to_swt_bff; /**<queue from ethernet stub to switch*/
struct tableRecord *switchTableCopy;
#define myID ETHERSTUBID
