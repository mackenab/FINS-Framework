...
int main(int argc, char *argv[]) {
	...
	printf("\n TCP Server waiting for client: port %d", ntohs(server_addr.sin_port));
	fflush(stdout);
	...
	printf("\n Connection establisehed sock_client=%d to (%s/%d) netw=%u", sock_client, inet_ntoa(client_addr.sin_addr),
